...
#am__append_13 = include/secp256k1_recovery.h
#am__append_14 =  \
#	src/modules/recovery/main_impl.h \
#	src/modules/recovery/tests_impl.h
#am__append_15 = bench_recover
subdir = .
...
SOURCES = $(libsecp256k1_la_SOURCES) $(libsecp256k1_common_la_SOURCES) \
	...
	$(bench_ecmult_SOURCES) $(bench_internal_SOURCES) \
	$(bench_recover_SOURCES) $(bench_sign_SOURCES) \
	$(bench_verify_SOURCES) $(exhaustive_tests_SOURCES) \
	$(tests_SOURCES)
...
ACLOCAL = ${SHELL} /tmp/secp256k1/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /tmp/secp256k1/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tmp/secp256k1/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tmp/secp256k1/build-aux/missing automake-1.15
AWK = gawk
BREW = 
BUILD_EXEEXT = 
BUILD_OBJEXT = 
...
CC_FOR_BUILD = gcc
CFLAGS = -g -O2 -W -std=c89 -pedantic -Wall -Wextra -Wcast-align -Wnested-externs -Wshadow -Wstrict-prototypes -Wno-unused-function -Wno-long-long -Wno-overlength-strings -O3
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /tmp/secp256k1/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
VERSION = 0.1
_ACJNI_JAVAC = 
abs_builddir = /tmp/secp256k1
abs_srcdir = /tmp/secp256k1
abs_top_builddir = /tmp/secp256k1
abs_top_srcdir = /tmp/secp256k1
ac_ct_AR = ar
ac_ct_CC = gcc
...
install_sh = ${SHELL} /tmp/secp256k1/build-aux/install-sh
...
$(srcdir)/src/modules/ecdh/Makefile.am.include $(srcdir)/src/modules/recovery/Makefile.am.include $(am__empty):
...
include src/$(DEPDIR)/bench_ecmult-bench_ecmult.Po
